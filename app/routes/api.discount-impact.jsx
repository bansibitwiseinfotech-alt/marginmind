...
/**
 * Resource Route: GET /api/discount-impact
 *
...
export const loader = async ({ request }) => {
  ...
  try {
    ...
    console.error("[MarginMind] API Discount Impact proxy error:", error);
    return Response.json(
      {
        success: false,
        message: error.message || "Failed to authenticate or fetch discount data",
      },
      {
        status: 500,
        headers: {
